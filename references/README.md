...
optional conversation evidence, default `running` runtime observations, and
distinct multi-user User Client URLs without reading Host or runner files.
...
Client URL rejection, before an operator attempts the real distributed proof.
