...
- Per-node agent runtime contracts now exist and default to OpenCode, and the
  ...
  profile, and default-agent overrides. Entangle Local still lacks the
  complete policy bridge, live OpenCode approval mapping, external
