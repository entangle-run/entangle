...
- Per-node agent runtime contracts now exist and default to OpenCode, and the
  ...
  policy bridge, live OpenCode approval mapping, external cancellation, non-primary publication
