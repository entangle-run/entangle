...
- Per-node agent runtime contracts now exist and default to OpenCode, and the
  ...
  across publication targets, approval-gated artifact replay/promotion workflow,
