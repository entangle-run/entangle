...
- Per-node agent runtime contracts now exist and default to OpenCode, and the
  ...
  turns and exposes sync outcomes through turn inspection. Entangle Local
  still lacks the complete policy bridge, live OpenCode approval mapping,
  external
  cancellation, non-primary publication provisioning/fallback, artifact
  restore/replay workflow, doctor integration, and richer runtime evidence
