...
- Local has reset-by-volume-teardown, a first read-only doctor diagnostic, and
  first versioned backup/validated restore commands, but no productized repair
  or upgrade command yet.
