...
| `strfry` | `https://github.com/hoytech/strfry.git` | Primary relay implementation candidate for Entangle Local: mature, fast, and simple to run as a dedicated local or containerized relay. | Cloned outside active worktree | `825e325cf93be03718cca157298392cba27d102f` |
...
For Entangle Local and likely for the first serious implementation:
