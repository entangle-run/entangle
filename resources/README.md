...
| `opencode` | `https://github.com/anomalyco/opencode.git` | Primary open-source coding-agent shell and the default candidate for Entangle's per-node coding engine. | Cloned outside active worktree | `9d1f17d83671fe2674ebbe31005e16bfaec12acc` |
